...
namespace MarysToyStore.DataAccess.Migrations
{
    ...
    [Migration("20210419150923_AddedAddress")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarysToyStore.DataAccess.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MarysToyStore.DataAccess.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MarysToyStore.DataAccess.Models.OrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MarysToyStore.DataAccess.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("MarysToyStore.DataAccess.Models.User", "User")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("MarysToyStore.DataAccess.Models.OrderLine", b =>
                {
                    b.HasOne("MarysToyStore.DataAccess.Models.Order", "Order")
                        .WithMany("OrderLines")
